...
ActiveRecord::Schema.define(version: 20170822000554) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["artwork_id", "liker_id"], name: "index_likes_on_artwork_id_and_liker_id", unique: true
    t.index ["comment_id", "liker_id"], name: "index_likes_on_comment_id_and_liker_id", unique: true
