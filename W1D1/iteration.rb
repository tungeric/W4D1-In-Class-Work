...
# def substrings(string)
#   result = []
#   string.length.downto(1) do |length|
#     string.each_cons(length) do |substr|
#       result << substrings
#     end
#   end
#   result.sort_by {|substr| [string.index(substr), substr.length]}
# end
